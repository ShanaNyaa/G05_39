...
<head>
    ...
    <title>Admin Car List Page</title>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th colspan="2" class="text-center">
                                    <form action="adminCarList.php" method="POST">
                                        ...
                                        while($row = mysqli_fetch_assoc($carList)) {
                                            ...
                                            $plateNumber = $row["plateNumber"];
                                                ...
                                                echo "<td class='text-center'>";
                                                    ...
                                                    echo "<input type='hidden' value='$plateNumber' name='plateNumberToUpdate'>";
                                                    echo '<button type="submit" class="btn btn-primary" name="updateButton">Update</button>';
                                                    echo "</form>";
                                                echo "</td>";
                                                echo "<td class='text-center'>";
                                                    echo '<form action="processCar.php" method="POST">';
                                                    echo "<input type='hidden' value='$plateNumber' name='plateNumberToDelete'>";
